...
(517, 'AllTimeHotelPresence', 'identity', 1, 5, 0, 0, 60),
(518, 'AllTimeHotelPresence', 'identity', 2, 10, 0, 5, 240),
...
(527, 'RespectGiven', 'social', 1, 5, 0, 0, 100),
...
ALTER TABLE `achievements`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26315;
COMMIT;
